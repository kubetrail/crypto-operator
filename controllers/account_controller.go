...
//+kubebuilder:rbac:groups=crypto.kubetrail.io,resources=accounts,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=crypto.kubetrail.io,resources=accounts/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=crypto.kubetrail.io,resources=accounts/finalizers,verbs=update
